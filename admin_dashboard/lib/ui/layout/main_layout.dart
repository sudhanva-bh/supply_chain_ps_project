  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget buildSidebar() {
      return GlassContainer(
        ...
        border: Border(right: BorderSide(color: AppTheme.dividerColor.withOpacity(0.5))),
        child: SizedBox(
          width: 250,
          child: Column(
            children: [
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: Icon(menuItems[index]['icon'], color: isSelected ? AppTheme.primaryText : AppTheme.secondaryText),
                      title: Text(
                      ...
                      selected: isSelected,
                      selectedTileColor: AppTheme.surfaceVariant.withOpacity(0.5),
                      onTap: () {
